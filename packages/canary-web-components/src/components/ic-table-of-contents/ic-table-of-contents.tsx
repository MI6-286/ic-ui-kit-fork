...
export class TableOfContents {
  ...
  supressListenerHandler() {
    ...
    // window.scrollTo(
    //   0,
    //   window.scrollY - window.innerHeight * ((100 - this.headerHeight) / 100)
    // );
  ...
  private updateSelectedItemFromScroll() {
    const targetHeight = window.scrollY + window.innerHeight / 2;
    if (window.scrollY === 0) {
    ...
    return (
      <Host>
        ...
        >
          ...
          >
            <ic-typography variant="h3">Table of Contents</ic-typography>
